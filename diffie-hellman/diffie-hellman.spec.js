...
describe('diffie-hellman', () => {
  ...
  test('can generate a shared secret from our private key and their public key', () => {
    ...
    expect(diffieHellman.getSharedSecret(alicePrivateKey, bobPublicKey)).toEqual(sharedSecret);

    expect(diffieHellman.getSharedSecret(bobPrivateKey, alicePublicKey)).toEqual(sharedSecret);
  });
});
