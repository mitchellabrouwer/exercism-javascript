...
describe("Triangle", () => {
  ...
  test("degenerate triangles have two sides that equal the third", () => {
    const triangle = new Triangle(2, 5, 7);
    expect(triangle.kind()).toEqual("degenerate");
  });

  test("degenerate triangles have two different sides that equal the third", () => {
    const triangle = new Triangle(12, 5, 7);
    expect(triangle.kind()).toEqual("degenerate");
  });

  test("degenerate triangles have two different sides that equal the third", () => {
    const triangle = new Triangle(2, 9, 7);
    expect(triangle.kind()).toEqual("degenerate");
  });
